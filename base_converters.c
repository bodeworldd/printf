...
/**
 * convert_sbase - Converts signed long to an inputted base and stores
 * the result to a buffer contained in a struct.
 * @output: buffer_t struct containing a character array.
 * @num: signed long to be converted.
 * @base: pointer to a string containing base to convert to.
...
/**
 * convert_ubase - Converts unsigned long to inputted base and
 * stores result to buffer contained in a struct.
